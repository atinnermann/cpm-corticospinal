function first_level_brain_FIR_2cond
...
if model == 1
    for sub = 1:nSubs
        ...
        for run = 1:nRuns
            ...
            matlabbatch{gi,sub}.spm.stats.fmri_spec.sess(run).cond(1).name     = 'Phasic_Pain';
...
if smooth == 1
    imgType = 'vcon'; %provide image type (beta,con,ess,spmT), otherwise []:con; all:con,beta,spmT
