function [problems] = first_level_brain_cc_pm3_ph1reg
...
fLevelName     = 'first_level_brain_hrf_cc_3pmods_iat_new';
onsName        = 'onsP_cc_ph1reg_new';
model          = 0;
vasa           = 0;
smooth         = 1;

pmodTime = [1:nTrials*nRuns]; %; %repmat(1:nTrials,1,nRuns)
...
if model == 1
    for sub = 1:nSubs
        ...
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.convec  = [0 0 0 0 1 0 0 0 noiseCon zeros(1,nRuns)];
        ...
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.convec  = [1 0 0 0 0 0 0 0 noiseCon zeros(1,nRuns)];
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.sessrep = 'none';

        %----- 3 -----%
        co = co + 1;
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.name    = 'Tonic_Pain';
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.convec  = [0 0 0 0 0 0 1 0 noiseCon zeros(1,nRuns)];
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.sessrep = 'none';

        %----- 4 -----%
        co = co + 1;
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.name    = 'Tonic_Pain_vs_NoPain';
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.convec  = [0 0 0 0 0 0 1 -1 noiseCon zeros(1,nRuns)];
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.sessrep = 'none';

        %----- 5 -----%
        co = co + 1;
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.name    = 'PMod_All';
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.convec  = [0 1 1 1 0 0 0 0 noiseCon zeros(1,nRuns)];
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.sessrep = 'none';

        %----- 6 -----%
        co = co + 1;
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.name    = 'PMod_1';
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.convec  = [0 1 0 0 0 0 0 0 noiseCon zeros(1,nRuns)];
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.sessrep = 'none';

        %----- 7 -----%
        co = co + 1;
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.name    = 'PMod_2';
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.convec  = [0 0 1 0 0 0 0 0 noiseCon zeros(1,nRuns)];
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.sessrep = 'none';

        %----- 8 -----%
        co = co + 1;
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.name    = 'PMod_3';
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.convec  = [0 0 0 1 0 0 0 0 noiseCon zeros(1,nRuns)];
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.sessrep = 'none';
