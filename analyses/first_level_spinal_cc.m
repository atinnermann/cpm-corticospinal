function [problems] = first_level_spinal_cc
...
if model == 1
    ...
    for sub = 1:nSubs
        ...
        %conditions: 'PhasicP','PhasicNP','Rating','Scale','TonicP','TonicNP'

        %----- 1 -----%
        co = 1;
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.name    = 'Rating';
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.convec  = [0 0 1 0 0 noiseCon zeros(1,nRuns)];
        ...
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.convec  = [1 1 0 0 0 noiseCon zeros(1,nRuns)];
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.sessrep = 'none';

        %----- 3 -----%
        co = co + 1;
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.name    = 'Tonic_Pain';
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.convec  = [0 0 0 1 0 noiseCon zeros(1,nRuns)];
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.sessrep = 'none';

        %----- 4 -----%
        co = co + 1;
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.name    = 'Tonic_Pain>Control';
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.convec  = [0 0 0 1 -1 noiseCon zeros(1,nRuns)];
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.tcon.sessrep = 'none';
        ...
        matlabbatch{gi,sub}.spm.stats.con.consess{co}.fcon.convec  = [eye(5)];
