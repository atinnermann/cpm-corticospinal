function second_level_spinal_MEPain
...
sLevelName     = 'ttest_spinal_phasic_cpm_vs_control'; 
...
for sub = 1:nSubs
    ...
    conFile = spm_select('FPList',subDir,sprintf('^s%dcon_%04d.nii',vars.smKernSp(1),conNumber));
