function second_level_spinal_MEPain_cov
...
sLevelName     = 'ttest_spinal_phasic_control_vs_cpm_covVAS'; %';
conNumber      = 6;
...
for sub = 1:nSubs
    ...
    conFile = spm_select('FPList',subDir,sprintf('^s1con_%04d.nii',conNumber));
...
brainMask = fullfile(baseDir,'mean_t2_template_seg.nii');
...
matlabbatch{1}.spm.stats.factorial_design.cov.cname = 'slope';
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'cov';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [0 1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = '-cov';
